...
public class Main {
	...
	private static String basePath = "META-INF/perpetuum/commands/";
	private static ResourceBundle pBundle = null;
	private static ResourceBundle cBundle = null;
	
	public static void init() {
		System.setProperty("perpetuum.commands.path", basePath);
	...
	public static void setupClasspath() {
		...
		URL classURL = Thread.currentThread().getContextClassLoader().getResource(basePath + "start.properties");
